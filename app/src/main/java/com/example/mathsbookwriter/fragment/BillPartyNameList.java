...
public class BillPartyNameList extends Fragment implements PartyNameInterface {

    private static final String TAG = BillPartyNameList.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_bill_party_name_ist, container, false);
